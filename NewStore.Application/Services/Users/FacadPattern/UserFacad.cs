...
namespace NewStore.Application.Services.Users.FacadPattern
{
    public class UserFacad : IUserFacad
    {
        ...
        private IGetCommonUserDetailsService _getCommonUserDetails;
        public IGetCommonUserDetailsService GetCommonUserDetails
        {
            get
            {
                return _getCommonUserDetails = _getCommonUserDetails ?? new GetCommonUserDetailsService(_context);
            }
